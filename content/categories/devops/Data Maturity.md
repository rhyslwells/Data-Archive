...
| Level                       | Description                                                                                                              |
| --------------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| Low data maturity leads to: | Repeated manual work<br>Conflicting numbers and definitions<br>Decisions made on intuition with retrospective validation |
| High data maturity enables: | Faster and more consistent decisions<br>Scalable analytics and automation<br>Trust in metrics across teams               |
